...
Version  : 22.04.3
Release  : 44
URL      : https://download.kde.org/stable/release-service/22.04.3/src/parley-22.04.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.3/src/parley-22.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.3/src/parley-22.04.3.tar.xz.sig
...
%prep
%setup -q -n parley-22.04.3
cd %{_builddir}/parley-22.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657553890
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/parley-22.04.3/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/parley/ee03d68f6be20b170e5ea5d114d6acafb3f2d1dc
cp %{_builddir}/parley-22.04.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/parley/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/parley-22.04.3/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/parley/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/parley-22.04.3/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/parley/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/parley-22.04.3/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/parley/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/parley-22.04.3/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/parley/81e12d0c07782abcf558af7aa19846e3e2606a70
pushd clr-build
%make_install
popd
%find_lang parley
