...
Version  : 25.04.2
Release  : 87
URL      : https://download.kde.org/stable/release-service/25.04.2/src/parley-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/parley-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/parley-25.04.2.tar.xz.sig
...
%setup -q -n parley-25.04.2
cd %{_builddir}/parley-25.04.2
pushd ..
cp -a parley-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749480967
mkdir -p clr-build
pushd clr-build
...
/usr/share/doc/HTML/sl/parley/index.cache.bz2
/usr/share/doc/HTML/sl/parley/index.docbook
