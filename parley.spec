...
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/parley-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/parley-23.08.4.tar.xz.sig
...
%prep
%setup -q -n parley-23.08.4
cd %{_builddir}/parley-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702924971
mkdir -p clr-build
pushd clr-build
