...
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/parley-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/parley-23.04.0.tar.xz.sig
...
%prep
%setup -q -n parley-23.04.0
cd %{_builddir}/parley-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682010302
mkdir -p clr-build
pushd clr-build
