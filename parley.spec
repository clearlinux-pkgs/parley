...
Version  : 24.05.0
Release  : 70
URL      : https://download.kde.org/stable/release-service/24.05.0/src/parley-24.05.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/parley-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/parley-24.05.0.tar.xz.sig
...
%setup -q -n parley-24.05.0
cd %{_builddir}/parley-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716503856
mkdir -p clr-build
pushd clr-build
