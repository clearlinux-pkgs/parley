...
Version  : 22.12.2
Release  : 52
URL      : https://download.kde.org/stable/release-service/22.12.2/src/parley-22.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/parley-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/parley-22.12.2.tar.xz.sig
...
%prep
%setup -q -n parley-22.12.2
cd %{_builddir}/parley-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676866977
mkdir -p clr-build
pushd clr-build
